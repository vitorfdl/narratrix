          ...
          <TabsContent value="template" className="space-y-3 mt-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <div className="border border-input rounded-md overflow-y-auto max-h-[50vh]">
                  <WidgetConfig
              ...
              <div className="space-y-1">
                ...
                />
                <p className="text-xs text-muted-foreground mt-0.5">Leave empty to use the default system prompt from the selected template</p>
              </div>
            </div>
          </TabsContent>
        </Tabs>
