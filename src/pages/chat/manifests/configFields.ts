...
export const configFields: ConfigFields = [
  ...
  },
  {
    name: "adaptive_p",
    type: "section",
    title: "Adaptive-P Sampling",
    description: "Selects tokens near a configurable target probability over time using an exponential moving average. Must be applied last in the sampler chain. Works well combined with Min-P.",
    fields: [
      {
        name: "adaptive_target",
        type: "stepbutton_slider",
        title: "Target",
        description: "Target probability for token selection. -1 disables the sampler. Higher values favor more probable tokens, lower values allow less likely ones.",
        min: -1,
        max: 1,
        default: -1,
        step: 0.05,
      },
      {
        ...
        type: "stepbutton_slider",
        title: "Decay",
        description: "EMA decay rate controlling adaptation speed. Lower values are more reactive to changes, higher values provide more stable behavior.",
        min: 0,
        max: 0.99,
        default: 0.9,
        step: 0.05,
    ...
    fields: [
      {
        ...
        description: "Maximum tokens to reserve for reasoning on providers that support a token budget. Use 0 to leave reasoning controlled by effort instead.",
        min: 0,
        max: 63999,
        step: 1024,
        default: 0,
      },
      {
        ...
        description: "Controls reasoning strength.\n-1 Off\n0 Minimal\n1 Low\n2 Medium\n3 High\n\nToken budget takes priority when supported.",
        min: -1,
        max: 3,
        step: 1,
        ticks: 5,
