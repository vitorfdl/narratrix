...
export default function Models() {
  ...
  const activeFilterLabel = settings.filter.type === "all" ? "All models" : MODEL_TYPE_DETAILS[settings.filter.type].label;
  const resultCountLabel = `${filteredAndSortedModels.length} ${filteredAndSortedModels.length === 1 ? "model" : "models"}`;
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                {activeFilterLabel} · {resultCountLabel}
              </p>
            </div>
