...
export const PROPERTY_FIELD_CONFIGS: PropertyFieldConfig[] = [
  {
    ...
    setValue: (_prop, value) => ({ name: value }),
  },
  {
    id: "type",
    label: "Type",
    ...
    setValue: (_prop, value) => ({ type: value }),
  },
  {
    id: "description",
    label: "Description",
    ...
    setValue: (_prop, value) => ({ description: value }),
  },
  {
    id: "required",
    label: "Required",
    ...
    setValue: (_prop, value) => ({ required: value }),
  },
  {
    id: "format",
    label: "Format",
    ...
    options: [{ value: "none", label: "None" }, ...STRING_FORMATS.map((format) => ({ value: format, label: format }))],
    getValue: (prop) => prop.format || "none",
    setValue: (_prop, value) => ({ format: value === "none" ? undefined : value }),
  },
  {
    id: "length",
  ...
  },
  {
    ...
    setValue: (_prop, value) => ({ pattern: value || undefined }),
  },
  {
    id: "enum",
    label: "Enum Values",
    ...
    setValue: (_prop, value) => ({ enum: value.length > 0 ? value : undefined }),
  },
  {
    id: "range",
