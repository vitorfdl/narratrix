CREATE TABLE IF NOT EXISTS format_template (
    ...
    FOREIGN KEY (context_template_id) REFERENCES context_template(id) ON DELETE SET NULL
); 
...
CREATE INDEX idx_format_template_context ON format_template(context_template_id);
